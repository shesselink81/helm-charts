...
```console
helm install my-release gh-shesselink81-public/wordpress-nginx
```
...
| Parameter                     | Description                                                                                                                                                                                                                      | Default                                                 |
|-------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|
| `image.registry`              | WordPress image registry                                                                                                                                                                                                         | `quay.io`                                             |
| `image.repository`            | WordPress image name                                                                                                                                                                                                             | `shesselink81/wordpress-nginx`                                     |
| `image.tag`                   | WordPress image tag                                                                                                                                                                                                              | `v6.1.1.6`                                            |
...
| `customHTAccessCM`            | Configmap with custom wordpress-htaccess.conf directives                                                                                                                                                                         | `custom-htaccess`                                                   |
...
| `ingress.hostname`                 | Default host for the ingress resource                                         | `wp.example.com`              |
